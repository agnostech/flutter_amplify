...
class FlutterAwsAmplifyPubSub {
  ...
  static Future<bool> initialize(
      String mqttClientId, String awsIoTEndPointUrl) async {
    try {
  ...
  static Future<bool> setAutoReconnect(bool autoReconnect) async {
    try {
      ...
      return await _methodChannel.invokeMethod("setAutoReconnect", arguments);
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }

  static Future<bool> setReconnectRetryLimits(
      int minTimeout, int maxTimeout) async {
    try {
      Map<String, dynamic> arguments = Map<String, dynamic>();
  ...
  static Future<int> getMinReconnectRetryTime() async {
    try {
      return await _methodChannel.invokeMethod("getMinReconnectRetryTime");
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }
  ...
  static Future<int> getMaxReconnectRetryTime() async {
    try {
      return await _methodChannel.invokeMethod("getMaxReconnectRetryTime");
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }
  ...
  static Future<int> getMaxAutoReconnectAttempts() async {
    try {
      return await _methodChannel.invokeMethod("getMaxAutoReconnectAttempts");
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }
  ...
  static Future<int> getConnectionStabilityTime() async {
    try {
      return await _methodChannel.invokeMethod("getConnectionStabilityTime");
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }
  ...
  static Future<bool> isOfflinePublishQueueEnabled() async {
    try {
      return await _methodChannel.invokeMethod("isOfflinePublishQueueEnabled");
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }
  ...
  static Future<int> getOfflinePublishQueueBound() async {
    try {
      return await _methodChannel.invokeMethod("getOfflinePublishQueueBound");
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }
  ...
  static Future<bool> setMqttLastWillAndTestament(
      int qos, String message, String topic) async {
    try {
      Map<String, dynamic> arguments = Map<String, dynamic>();
      arguments['qos'] = qos;
  ...
  static Future<bool> setAutoResubscribe(bool enabled) async {
    try {
      Map<String, dynamic> arguments = Map<String, dynamic>();
      arguments['enabled'] = enabled;
      return await _methodChannel.invokeMethod("setAutoResubscribe", arguments);
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }
  ...
  static Future<bool> setCleanSession(bool cleanSession) async {
    try {
      ...
      return await _methodChannel.invokeMethod("setCleanSession", arguments);
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }
  ...
  static Future<bool> subscribeToTopic(
      String subscriptionTopic, int qos) async {
    try {
      Map<String, dynamic> arguments = Map<String, dynamic>();
      arguments['subscriptionTopic'] = subscriptionTopic;
      arguments['qos'] = qos;
      return await _methodChannel.invokeMethod("subscribeToTopic", arguments);
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }
  ...
  static Future<bool> unsubscribeTopic(String topic) async {
    try {
      Map<String, dynamic> arguments = Map<String, dynamic>();
      arguments['topic'] = topic;
      return await _methodChannel.invokeMethod("unsubscribeTopic", arguments);
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }

  static Future<bool> attachPolicy(String policyName, String awsRegion) async {
    try {
      Map<String, dynamic> arguments = Map<String, dynamic>();
  ...
  static Future<bool> publishString(
      String payload, String topic, int qos) async {
    try {
      Map<String, dynamic> arguments = Map<String, dynamic>();
      arguments['topic'] = topic;
      arguments['payload'] = payload;
      arguments['qos'] = qos;
      return await _methodChannel.invokeMethod("publishString", arguments);
    } on PlatformException catch (e) {
      return Future.error(e);
    }
  }
